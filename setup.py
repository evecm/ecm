...
def install(options):
    ...
    log.info("")
    log.info("Apache virtual host file '%s' generated. Please include it to your apache configuration.", vhost_file)
    log.info("")
    log.info("Note: if needed, you can edit '%s' to change database and email settings.", settings_file)
