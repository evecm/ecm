...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GroupFilter.group_name'
        db.delete_column('pos_groupfilter', 'group_name')

        # Adding field 'GroupFilter.group'
        db.add_column('pos_groupfilter', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='group', null=True, to=orm['auth.Group']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'GroupFilter.group_name'
        db.add_column('pos_groupfilter', 'group_name',
    ...
    models = {
        ...
        'pos.groupfilter': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'group'", 'null': 'True', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
