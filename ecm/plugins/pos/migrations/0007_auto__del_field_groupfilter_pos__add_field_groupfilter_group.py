...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GroupFilter.pos'
        db.delete_column('pos_groupfilter', 'pos_id')

        # Adding field 'GroupFilter.group'
        db.add_column('pos_groupfilter', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='group', null=True, to=orm['auth.Group']),
                      keep_default=False)

        # Removing M2M table for field group on 'GroupFilter'
        db.delete_table('pos_groupfilter_group')

        # Adding M2M table for field pos on 'GroupFilter'
        db.create_table('pos_groupfilter_pos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groupfilter', models.ForeignKey(orm['pos.groupfilter'], null=False)),
            ('pos', models.ForeignKey(orm['pos.pos'], null=False))
        ))
        db.create_unique('pos_groupfilter_pos', ['groupfilter_id', 'pos_id'])

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GroupFilter.pos'
        raise RuntimeError("Cannot reverse this migration. 'GroupFilter.pos' and its values cannot be restored.")
        ...
        # Removing M2M table for field pos on 'GroupFilter'
        db.delete_table('pos_groupfilter_pos')
    ...
    models = {
        ...
        'pos.groupfilter': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group'", 'null': 'True', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pos': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'group_filter'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['pos.POS']"})
        },
        'pos.pos': {
