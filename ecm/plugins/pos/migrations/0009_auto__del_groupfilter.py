...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'GroupFilter'
        db.delete_table('pos_groupfilter')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'GroupFilter'
        db.create_table('pos_groupfilter', (
            ('all', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='group', null=True, to=orm['auth.Group'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('pos', ['GroupFilter'])
