...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PricingPolicy.category_id'
        db.add_column('industry_pricingpolicy', 'category_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PricingPolicy.category_id'
        db.delete_column('industry_pricingpolicy', 'category_id')
