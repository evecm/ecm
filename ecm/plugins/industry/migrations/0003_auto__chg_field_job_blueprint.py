...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.blueprint'
        db.alter_column(u'industry_job', 'blueprint_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['industry.OwnedBlueprint']))

    def backwards(self, orm):

        # Changing field 'Job.blueprint'
        db.alter_column(u'industry_job', 'blueprint_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['industry.OwnedBlueprint']))
