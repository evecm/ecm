...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('industry_pricingpolicy', (
            ...
            ('item_group', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('user_group', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('user_group_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('surcharge_absolute', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True)),
    ...
    models = {
        ...
        'industry.pricingpolicy': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_group': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'item_group_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'item_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'surcharge_absolute': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
            'surcharge_relative': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'user_group': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'user_group_id': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'industry.supply': {
