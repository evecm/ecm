...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PricingPolicy.active'
        db.add_column('industry_pricingpolicy', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PricingPolicy.active'
        db.delete_column('industry_pricingpolicy', 'active')
