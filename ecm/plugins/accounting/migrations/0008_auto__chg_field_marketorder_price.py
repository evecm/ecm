...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarketOrder.price'
        db.alter_column('accounting_marketorder', 'price', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'MarketOrder.price'
        db.alter_column('accounting_marketorder', 'price', self.gf('django.db.models.fields.PositiveIntegerField')())
