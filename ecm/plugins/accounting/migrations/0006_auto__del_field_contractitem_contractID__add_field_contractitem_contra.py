...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContractItem.contractID'
        db.delete_column('accounting_contractitem', 'contractID_id')

        # Adding field 'ContractItem.contract'
        db.add_column('accounting_contractitem', 'contract', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounting.Contract']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ContractItem.contractID'
        db.add_column('accounting_contractitem', 'contractID', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='contract', to=orm['accounting.Contract']), keep_default=False)

        # Deleting field 'ContractItem.contract'
        db.delete_column('accounting_contractitem', 'contract_id')
