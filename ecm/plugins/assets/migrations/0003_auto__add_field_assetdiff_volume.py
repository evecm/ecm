...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assets_assetdiff', 'volume', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'assets.assetdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 15, 20, 47, 393203)', 'db_index': 'True'}),
            'flag': ('django.db.models.fields.BigIntegerField', [], {}),
            'hangarID': ('django.db.models.fields.PositiveIntegerField', [], {}),
