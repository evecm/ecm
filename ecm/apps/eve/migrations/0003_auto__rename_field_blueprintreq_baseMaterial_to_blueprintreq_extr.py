...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # renaming field 'BlueprintReq.baseMaterial' to 'BlueprintReq.extraQuantity'
        db.rename_column(u'eve_blueprintreq', 'baseMaterial', 'extraQuantity')


    def backwards(self, orm):
        # renaming field  'BlueprintReq.extraQuantity' to 'BlueprintReq.baseMaterial'
        db.rename_column(u'eve_blueprintreq', 'extraQuantity', 'baseMaterial')
    ...
    models = {
        'eve.blueprintreq': {
            ...
            'extraQuantity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
