...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding field 'BlueprintType.researchTechTime'
        db.add_column(u'eve_blueprinttype', 'researchTechTime',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlueprintType.productivityModifier'
        db.add_column(u'eve_blueprinttype', 'productivityModifier',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlueprintType.wasteFactor'
        db.add_column(u'eve_blueprinttype', 'wasteFactor',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlueprintType.materialModifier'
        db.add_column(u'eve_blueprinttype', 'materialModifier',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlueprintType.techLevel'
        db.add_column(u'eve_blueprinttype', 'techLevel',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BlueprintType.inventionTime'
        db.delete_column(u'eve_blueprinttype', 'inventionTime')

        # Adding field 'BlueprintReq.extraQuantity'
        db.add_column(u'eve_blueprintreq', 'extraQuantity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BlueprintReq.damagePerJob'
        db.add_column(u'eve_blueprintreq', 'damagePerJob',
