...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'hr.recruit': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recruiter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recruiter'", 'to': "orm['auth.User']"}),
            'reference': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'reference+'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
