...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hr_employmenthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='employment_history', to=orm['hr.Member'])),
            ('recordID', self.gf('django.db.models.fields.BigIntegerField')()),
            ('corporation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='employment_history', to=orm['corp.Corporation'])),
            ('startDate', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('hr', ['EmploymentHistory'])


    def backwards(self, orm):
        # Deleting model 'EmploymentHistory'
        db.delete_table(u'hr_employmenthistory')
    ...
    models = {
        ...
        u'corp.corporation': {
            ...
            'alliance': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'corporations'", 'null': 'True', 'to': u"orm['corp.Alliance']"}),
        ...
        'hr.employmenthistory': {
            ...
            'corporation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'employment_history'", 'to': u"orm['corp.Corporation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'employment_history'", 'to': "orm['hr.Member']"}),
        ...
        'hr.member': {
            ...
            'corp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'members'", 'null': 'True', 'to': u"orm['corp.Corporation']"}),
            ...
            'is_cyno_alt': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'characters'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        'hr.recruit': {
            'Meta': {'object_name': 'Recruit'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recruiter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'recruiter'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'reference': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'reference'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
        ...
        'hr.role': {
            ...
            'hangar': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['corp.Hangar']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'wallet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['corp.Wallet']", 'null': 'True', 'blank': 'True'})
        },
        'hr.rolememberdiff': {
        ...
        'hr.title': {
            ...
            'accessLvl': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
            'corp': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'titles'", 'to': u"orm['corp.Corporation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hr.titlecompodiff': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'title_compo_diffs'", 'to': "orm['hr.Role']"}),
            'title': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'title_compo_diffs'", 'to': "orm['hr.Title']"})
        },
        'hr.titlecomposition': {
        ...
        'hr.titlememberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'title_member_diffs'", 'to': "orm['hr.Member']"}),
            'new': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'title': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'title_member_diffs'", 'to': "orm['hr.Title']"})
        },
        'hr.titlemembership': {
