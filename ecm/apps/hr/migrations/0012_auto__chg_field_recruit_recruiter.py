...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recruit.recruiter'
        db.alter_column('hr_recruit', 'recruiter_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Recruit.recruiter'
        db.alter_column('hr_recruit', 'recruiter_id', self.gf('django.db.models.fields.related.ForeignKey')(default='-', to=orm['auth.User']))
    ...
    models = {
        ...
        'hr.recruit': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recruiter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'recruiter'", 'null': 'True', 'to': "orm['auth.User']"}),
            'reference': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'reference'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
