...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hr_title', (
            ...
            ('corp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='titles', to=orm['corp.Corporation'])),
            ('titleID', self.gf('django.db.models.fields.BigIntegerField')()),
