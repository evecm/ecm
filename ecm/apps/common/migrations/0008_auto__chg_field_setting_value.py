...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('common_setting', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Setting.value'
        db.alter_column('common_setting', 'value', self.gf('django.db.models.fields.CharField')(max_length=1000))
