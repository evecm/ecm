...
class Subcommand(object):
    ...
    """
    def __init__(self, name, parser=None, help='', aliases=(), callback=None): #@ReservedAssignment
    ...
    def run(self, *args, **kwargs):
        if self.callback is None:
            raise UserWarning('SubCommand "%s" has no callback function defined.' % self.name)
        else:
