...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.notes'
        db.alter_column('roles_member', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Member.location'
        db.alter_column('roles_member', 'location', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Changing field 'Member.notes'
        db.alter_column('roles_member', 'notes', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Member.location'
        db.alter_column('roles_member', 'location', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'roles.member': {
            ...
            'corpDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 3, 27, 34, 713000)'}),
            'corped': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'lastLogin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 3, 27, 34, 713000)'}),
            'lastLogoff': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 3, 27, 34, 713000)'}),
        ...
        'roles.memberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 3, 27, 34, 716000)', 'db_index': 'True'}),
        ...
        'roles.rolememberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 2, 3, 27, 34, 717000)', 'db_index': 'True'}),
            'id': ('ecm.lib.bigintpatch.BigAutoField', [], {'primary_key': 'True'}),
