...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('roles_member', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.notes'
        db.delete_column('roles_member', 'notes')
    ...
    models = {
        ...
        'roles.member': {
            ...
            'corpDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 0, 43, 39, 231000)'}),
            'corped': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'lastLogin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 0, 43, 39, 231000)'}),
            'lastLogoff': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 0, 43, 39, 231000)'}),
        ...
        'roles.memberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 0, 43, 39, 235000)', 'db_index': 'True'}),
        ...
        'roles.rolememberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 0, 43, 39, 236000)', 'db_index': 'True'}),
            'id': ('ecm.lib.bigintpatch.BigAutoField', [], {'primary_key': 'True'}),
        ...
        'roles.titlecompodiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 1, 0, 43, 39, 234000)', 'db_index': 'True'}),
            'id': ('ecm.lib.bigintpatch.BigAutoField', [], {'primary_key': 'True'}),
            'new': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['roles.Role']"}),
