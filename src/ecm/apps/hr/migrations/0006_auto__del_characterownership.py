...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('roles_characterownership', (
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='__characters', to=orm['auth.User'])),
            ('is_main_character', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('character', self.gf('django.db.models.fields.related.OneToOneField')(related_name='__ownership', unique=True, to=orm['roles.Member'])),
    ...
    models = {
        ...
        'roles.member': {
            ...
            'corpDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 3, 41, 0, 716000)'}),
            'corped': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'lastLogin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 3, 41, 0, 716000)'}),
            'lastLogoff': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 3, 41, 0, 716000)'}),
        ...
        'roles.memberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 3, 41, 0, 716000)', 'db_index': 'True'}),
        ...
        'roles.rolememberdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 6, 3, 41, 0, 732000)', 'db_index': 'True'}),
            'id': ('ecm.lib.bigintpatch.BigAutoField', [], {'primary_key': 'True'}),
