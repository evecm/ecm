...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('common_url_groups', 'common_urlpermission_groups')
        db.rename_column('common_urlpermission_groups', 'url_id', 'urlpermission_id')
        db.rename_table('common_url', 'common_urlpermission')


    def backwards(self, orm):
        db.rename_table('common_urlpermission_groups', 'common_url_groups')
        db.rename_column('common_url_groups', 'urlpermission_id', 'url_id')
        db.rename_table('common_urlpermission', 'common_url')
