...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assets_asset', 'closest_object_id', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)

        # Adding field 'Asset.name'
        db.add_column('assets_asset', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'assets.assetdiff': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 23, 32, 21, 118000)', 'db_index': 'True'}),
            'flag': ('django.db.models.fields.BigIntegerField', [], {}),
            'hangarID': ('django.db.models.fields.PositiveIntegerField', [], {}),
