...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FuelLevel.consumption'
        db.add_column('pos_fuellevel', 'consumption', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FuelLevel.consumption'
        db.delete_column('pos_fuellevel', 'consumption')
